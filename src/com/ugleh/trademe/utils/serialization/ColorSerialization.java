 ...
 * org.bukkit.Color, to provide support to create a color using BGR <i>and</i> RGB formats.
 *
...
public class ColorSerialization {
    ...
    /**
     * Serialize a Color into JSONObject form. Colors are serialized into a JSONObject with red,
     * green, and blue as keys
     *
    ...
    /**
     * Get a Color from a JSONObject. If any one of the red, green, or blue keys are not found, they
     * are given a value of 0 by default. Therefore, if the red and green values found were both 0,
